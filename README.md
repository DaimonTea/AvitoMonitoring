Работа над программой всё ещё ведётся, и завершена примерно на половину.
...
4. ID пользователя/чата, куда нужно отправлять уведомления (ID Вашего аккаунта можно узнать в t.me/userinfobot; для отправки в супергруппы/каналы нужно добавлять префикс -100 к их ID)
...
<img src="images/avito_desktop_searchline.png" alt="desktop_searchline" width=400>
<span style="opacity: 0.2;">Десктопная версия</span>

<img src="images/avito_mobile_searchline.png" alt="desktop_searchline" width=400>
<span style="opacity: 0.2;">Мобильная версия</span>
...
Задержка должна быть не меньше 8-12 секунд (в зависимости от скорости интернета), если запущен только 1 инстанс данной программы,
а при запуске нескольких процессов задержка должна быть не меньше ((от 8 до 12 в зависимости от интернета) * количество запущенных экземпляров программы) секунд.
