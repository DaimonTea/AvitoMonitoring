...
> [!WARNING]
> Так как семафоры (Semaphores) не поддерживаются на Unix-системах, в Releases пока будет выложена только версия программы для Windows. Работа над версией программы с поддержкой Unix будет вестись, но гарантий на её выход нет.
...
4. ID пользователя/чата, куда нужно отправлять уведомления t.me/userinfobot; для отправки в супергруппы/каналы нужно добавлять префикс -100 к их ID)
