...
а при запуске нескольких процессов задержка должна быть не меньше ((от 20-25 в зависимости от интернета) * количество запущенных экземпляров программы) секунд.
