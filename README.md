...
Задержка должна быть не меньше 11-15 секунд (в зависимости от скорости интернета), если запущен только 1 инстанс данной программы,
а при запуске нескольких процессов задержка должна быть не меньше ((от 11 до 15 в зависимости от интернета) * количество запущенных экземпляров программы) секунд.
